...
nnoremap <silent><leader> <C-p> <cmd>Lspsaga diagnostic_jump_prev<CR>
nnoremap <silent><leader> <C-n> <cmd>Lspsaga diagnostic_jump_next<CR>
...
xnoremap <silent><leader> ga    <cmd>Lspsaga range_code_action<CR>
